...
JTagMap::JTagMap(JNIEnv *env) : env(env) {
    ...
    auto jTagMapClass = std::make_unique<JClassRef>(
            env,
            "com/lonx/audiotag/internal/NativeTagMap"
    );

    auto jTagMapInitMethod =
            jTagMapClass->method("<init>", "()V");

    jTagMap = std::move(
            std::make_unique<JObjectRef>(
                    env,
                    env->NewObject(**jTagMapClass, jTagMapInitMethod)
            )
    );

    jTagMapAddIdSingleMethod =
            jTagMapClass->method(
                    "addID",
                    "(Ljava/lang/String;Ljava/lang/String;)V"
            );

    jTagMapAddIdListMethod =
            jTagMapClass->method(
                    "addID",
                    "(Ljava/lang/String;Ljava/util/List;)V"
            );

    jTagMapAddCustomSingleMethod =
            jTagMapClass->method(
                    "addCustom",
                    "(Ljava/lang/String;Ljava/lang/String;)V"
            );

    jTagMapAddCustomListMethod =
            jTagMapClass->method(
                    "addCustom",
                    "(Ljava/lang/String;Ljava/util/List;)V"
            );

    jTagMapAddCombinedSingleMethod =
            jTagMapClass->method(
                    "addCombined",
                    "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"
            );

    jTagMapAddCombinedListMethod =
            jTagMapClass->method(
                    "addCombined",
    ...
    jArrayListInitMethod =
            jArrayListClass->method("<init>", "()V");

    jArrayListAddMethod =
            jArrayListClass->method(
                    "add",
                    "(Ljava/lang/Object;)Z"
            );
}
