...
Devkit 放在插件仓库 [Replica0110/Lyrico-Plugins](https://github.com/Replica0110/Lyrico-Plugins) 中。工具位置：
...
在 [Replica0110/Lyrico-Plugins](https://github.com/Replica0110/Lyrico-Plugins) 仓库根目录执行：
